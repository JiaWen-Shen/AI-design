...
```
「把 company/design-system 這個 repo clone 到 ~/work/company/ 底下」
```

Agent 會執行：
```bash
cd ~/work/company/
git clone git@github.com:company/design-system.git
```

結果：`~/work/company/design-system/` 資料夾就建立了，而且已經連結到 remote repo。
